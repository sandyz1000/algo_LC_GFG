...
# Python program to demonstrate implementation of our own hash table with chaining for collision
# detection
...
class Map:
    ...
    def __init__(self):
        ...
        self.num_buckets = 10  # Current capacity of array list

        # bucketArray is used to store array of chains
        self.bucket_array = [None] * self.num_buckets
        self.size = 0  # Current size of array list
...
if __name__ == '__main__':
    ...
    _map.add("hi", 5)
    # print(_map.size)
    print(_map.get("coder"))
    print(_map.remove("this"))
    print(_map.remove("this"))
    # print(_map.size)
    print(_map.is_empty())
