...
def max_repeating(arr, n, k):
    ...
    # arr = [arr[i] % k for i in range(n)]
    return result  # Return index of the maximum element
...
if __name__ == '__main__':
    ...
    n = len(arr)
    k = 8
    print("The maximum repeating number is ", max_repeating(arr, n, k))
