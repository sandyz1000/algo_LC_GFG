...
def pair_in_sorted_rotated(arr, n, x):
    ...
    left = (i + 1) % n  # left is now index of minimum element
    right = i  # right is now index of maximum element
...
if __name__ == '__main__':
    ...
    if pair_in_sorted_rotated(arr, n, total):
        print("Array has two elements with sum %s" % total)
    else:
        print("Array doesn't have two elements with sum %d " % total)
